...
drive_download(drive_folder[grepl('knz_herbivore', drive_folder$name),], path = tmp, overwrite = TRUE)
knz_herb_wide <- read.csv(tmp)


calculate_agg_stability(producer_data = knz_prod_wide, consumer_data = knz_con_wide, herbivore_data = knz_herb_wide,
                        "knz")
...
drive_download(drive_folder[grepl('kbs_herbivore', drive_folder$name),], path = tmp, overwrite = TRUE)
kbs_herb_wide <- read.csv(tmp)

calculate_agg_stability(producer_data = kbs_prod_wide, consumer_data = kbs_con_wide, herbivore_data = kbs_herb_wide,
                        "kbs")
...
drive_download(drive_folder[grepl('cdr_of_herbivore', drive_folder$name),], path = tmp, overwrite = TRUE)
cdr_of_herb_wide <- read.csv(tmp)

calculate_agg_stability(producer_data = cdr_of_prod_wide, consumer_data = cdr_of_con_wide, herbivore_data = cdr_of_herb_wide,
                        "cdr_of")
...
drive_download(drive_folder[grepl('jrn_herbivore', drive_folder$name),], path = tmp, overwrite = TRUE)
jrn_herb_wide <- read.csv(tmp)

calculate_agg_stability(producer_data = jrn_prod_wide, consumer_data = jrn_con_wide, herbivore_data = jrn_herb_wide,
                        "jrn")
...
drive_download(drive_folder[grepl('bex_he_herbivore', drive_folder$name),], path = tmp, overwrite = TRUE)
bex_he_herb_wide <- read.csv(tmp)
...
drive_download(drive_folder[grepl('bex_ae_herbivore', drive_folder$name),], path = tmp, overwrite = TRUE)
bex_ae_herb_wide <- read.csv(tmp)
...
drive_download(drive_folder[grepl('bex_se_herbivore', drive_folder$name),], path = tmp, overwrite = TRUE)
bex_se_herb_wide <- read.csv(tmp)

calculate_agg_stability(producer_data = bex_he_prod_wide, consumer_data = bex_he_con_wide, herbivore_data = bex_he_herb_wide,
                        "bex_he")
calculate_agg_stability(producer_data = bex_ae_prod_wide, consumer_data = bex_ae_con_wide, herbivore_data = bex_ae_herb_wide,
                        "bex_ae")
calculate_agg_stability(producer_data = bex_se_prod_wide, consumer_data = bex_se_con_wide, herbivore_data = bex_se_herb_wide,
                        "bex_se")
...
write.csv(row.names = F, terrestrial_agg_stability, 'data/synthesized_data/terrestrial_agg_dss_12082025.csv')
...
drive_download(drive_folder[grepl('gce_herbivore', drive_folder$name),], path = tmp, overwrite = TRUE)
gce_herb_wide <- read.csv(tmp)


calculate_agg_stability(producer_data = gce_prod_wide, consumer_data = gce_con_wide, herbivore_data = gce_herb_wide,
                        "gce")
...
drive_download(drive_folder[grepl('usvi_fish_herbivore', drive_folder$name),], path = tmp, overwrite = TRUE)
usvi_fish_herb_wide <- read.csv(tmp)
calculate_agg_stability(producer_data = usvi_fish_prod_wide, consumer_data = usvi_fish_con_wide, herbivore_data = usvi_fish_herb_wide,
                        "usvi_fish")
...
drive_download(drive_folder[grepl('sbc_invert_herbivore', drive_folder$name),], path = tmp, overwrite = TRUE)
sbc_invert_herb_wide <- read.csv(tmp)
calculate_agg_stability(producer_data = sbc_invert_prod_wide, consumer_data = sbc_invert_con_wide, herbivore_data = sbc_invert_herb_wide,
                        "sbc_invert")
...
drive_download(drive_folder[grepl('sbc_fish_herbivore', drive_folder$name),], path = tmp, overwrite = TRUE)
sbc_fish_herb_wide <- read.csv(tmp)
calculate_agg_stability(producer_data = sbc_fish_prod_wide, consumer_data = sbc_fish_con_wide, herbivore_data = sbc_fish_herb_wide,
                        "sbc_fish")
...
drive_download(drive_folder[grepl('mcr_invert_herbivore', drive_folder$name),], path = tmp, overwrite = TRUE)
mcr_invert_herb_wide <- read.csv(tmp)

calculate_agg_stability(producer_data = mcr_invert_prod_wide, consumer_data = mcr_invert_con_wide, herbivore_data = mcr_invert_herb_wide,
                        "mcr_invert")
...
drive_download(drive_folder[grepl('mcr_fish_herbivore', drive_folder$name),], path = tmp, overwrite = TRUE)
mcr_fish_herb_wide <- read.csv(tmp)

calculate_agg_stability(producer_data = mcr_fish_prod_wide, consumer_data = mcr_fish_con_wide, herbivore_data = mcr_fish_herb_wide,
                        "mcr_fish")
...
#
drive_download(drive_folder[grepl('aims_herbivore', drive_folder$name),], path = tmp, overwrite = TRUE)
aims_herb_wide <- read.csv(tmp)

calculate_agg_stability(producer_data = aims_prod_wide, consumer_data = aims_con_wide, herbivore_data = aims_herb_wide,
                        "aims")
...
#
drive_download(drive_folder[grepl('ntl_trout_herbivore', drive_folder$name),], path = tmp, overwrite = TRUE)
ntl_trout_herb_wide <- read.csv(tmp)

calculate_agg_stability(producer_data = ntl_trout_prod_wide, consumer_data = ntl_trout_con_wide, herbivore_data = ntl_trout_herb_wide,
                        "ntl_trout")
...
drive_download(drive_folder[grepl('ntl_madison_herbivore', drive_folder$name),], path = tmp, overwrite = TRUE)
ntl_madison_herb_wide <- read.csv(tmp)

calculate_agg_stability(producer_data = ntl_madison_prod_wide, consumer_data = ntl_madison_con_wide, herbivore_data = ntl_madison_herb_wide,
                        "ntl_madison")
...
drive_download(drive_folder[grepl('adk_herbivore', drive_folder$name),], path = tmp, overwrite = TRUE)
adk_herb_wide <- read.csv(tmp)

calculate_agg_stability(producer_data = adk_prod_wide, consumer_data = adk_con_wide, herbivore_data = adk_herb_wide,
                        "adk")
...
write.csv(row.names = F, marine_agg_stability, 'data/synthesized_data/marine_agg_dss_12082025.csv')
...
write.csv(row.names = F, combined_agg_stability, 'data/synthesized_data/combined_agg_dss_12082025.csv')
googledrive::drive_upload(media = file.path("data/synthesized_data/combined_agg_dss_12082025.csv"), overwrite = T,
                          path = googledrive::as_id("https://drive.google.com/drive/folders/1xa-ypKd_ovsRov_Ol_uvE7ZI2rCc5SSj"))
