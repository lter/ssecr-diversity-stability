...
#  stat_cor(aes(label = paste(..rr.label.., ..p.label.., sep = ", ")), method = "pearson") + 
  ...
  labs(x='Total richness of producers', y='Producer aggregated stability', title="Producer diversity-stability relationship") +
  theme_bw()
...
#  stat_cor(aes(label = paste(..rr.label.., ..p.label.., sep = ", ")), method = "pearson") + 
  ...
  labs(x='Total richness of consumers', y='Consumer aggregated stability', title="Consumer diversity-stability relationship") +
  theme_bw()
...
ggplot(knz_agg_dss, aes(x=prod_richness, y=con_richness)) +
  ...
  labs(x='Total richness of producers', y='Total richness of consumers', title="Producer and consumer diversity relationship") +
  theme_bw()
#
