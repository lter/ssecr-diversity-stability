...
data_phyto_trout_out$confidence <- TRUE
data_phyto_trout_out$confidence[data_phyto_trout_out$species=="Miscellaneous"] <- FALSE
####
...
data_zoop_trout_out$species_code <- data_zoop_trout$species_code
###
### set the rows without species name as not confident
data_zoop_trout_out$confidence <- TRUE
data_zoop_trout_out$confidence[data_zoop_trout_out$species==''] <- FALSE
###
...
####
data_binvert_out$confidence <- TRUE
data_binvert_out$confidence[data_binvert_out$species==""] <- FALSE
#
