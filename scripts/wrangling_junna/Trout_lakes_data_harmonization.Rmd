...
# remove rows with empty taxon_name
data_phyto_trout_out <- data_phyto_trout_out[data_phyto_trout_out$taxon_name != '', ]
...
# remove rows 
data_zoop_trout_out <- data_zoop_trout_out[data_zoop_trout_out$taxon_name != '', ]
