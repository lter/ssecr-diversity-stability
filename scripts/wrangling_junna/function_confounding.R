...
control_confounder <- function(data) {
  ...
  data$prod_richness_log <- log(data$prod_richness)
  data$herb_richness_log <- log(data$herb_richness)
  data$con_richness_log <- log(data$con_richness)
