...
#
fish_data_out  <- fish_data_out %>% mutate(taxa_type="consumer", ecosystem="aquatic", habitat_broad='marine', biome='tropic', guild='fish', unit_abundance='biomass', scale_abundance='per transect', unique_ID=paste(site, habitat_fine, plot, sep='_'), id_confidence=TRUE) %>% mutate(herbivore=case_when(TrophicGroup %in% c("herb", "omni") ~ "yes",
